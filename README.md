...
[![](https://img.shields.io/docker/pulls/2fk/upx.svg)](https://hub.docker.com/r/2fk/upx) [![](https://img.shields.io/docker/cloud/automated/2fk/upx.svg)](https://hub.docker.com/r/2fk/upx) [![](https://img.shields.io/docker/stars/2fk/upx.svg)](https://hub.docker.com/r/2fk/upx)
...
```console
$ docker run --rm -v $PWD:/data 2fk/upx -k --best --ultra-brute main
